...
class SentenceFactory private constructor() {
    ...
    fun reset() {
        ...
        registerParser("APB", { s -> APBParser(s) }, { t -> APBParser(t) })
        registerParser("ALK", { s -> STALKParser(s) }, { t -> STALKParser(t) })
        registerParser("BOD", { s -> BODParser(s) }, { t -> BODParser(t) })
        registerParser("CUR", { s -> CURParser(s) }, { t -> CURParser(t) })
        registerParser("DBT", { s -> DBTParser(s) }, { t -> DBTParser(t) })
        registerParser("DPT", { s -> DPTParser(s) }, { t -> DPTParser(t) })
        registerParser("DTM", { s -> DTMParser(s) }, { t -> DTMParser(t) })
        registerParser("GBS", { s -> GBSParser(s) }, { t -> GBSParser(t) })
        registerParser("GGA", { s -> GGAParser(s) }, { t -> GGAParser(t) })
        registerParser("GLL", { s -> GLLParser(s) }, { t -> GLLParser(t) })
        registerParser("GNS", { s -> GNSParser(s) }, { t -> GNSParser(t) })
        registerParser("GSA", { s -> GSAParser(s) }, { t -> GSAParser(t) })
        registerParser("GST", { s -> GSTParser(s) }, { t -> GSTParser(t) })
        registerParser("GSV", { s -> GSVParser(s) }, { t -> GSVParser(t) })
        registerParser("HDG", { s -> HDGParser(s) }, { t -> HDGParser(t) })
        registerParser("HDM", { s -> HDMParser(s) }, { t -> HDMParser(t) })
        registerParser("HDT", { s -> HDTParser(s) }, { t -> HDTParser(t) })
        registerParser("HTC", { s -> HTCParser(s) }, { t -> HTCParser(t) })
        registerParser("HTD", { s -> HTDParser(s) }, { t -> HTDParser(t) })
        registerParser("MHU", { s -> MHUParser(s) }, { t -> MHUParser(t) })
        registerParser("MMB", { s -> MMBParser(s) }, { t -> MMBParser(t) })
        registerParser("MTA", { s -> MTAParser(s) }, { t -> MTAParser(t) })
        registerParser("MTW", { s -> MTWParser(s) }, { t -> MTWParser(t) })
        registerParser("MWV", { s -> MWVParser(s) }, { t -> MWVParser(t) })
        registerParser("OSD", { s -> OSDParser(s) }, { t -> OSDParser(t) })
        registerParser("RMB", { s -> RMBParser(s) }, { t -> RMBParser(t) })
        registerParser("RMC", { s -> RMCParser(s) }, { t -> RMCParser(t) })
        registerParser("RPM", { s -> RPMParser(s) }, { t -> RPMParser(t) })
        registerParser("ROT", { s -> ROTParser(s) }, { t -> ROTParser(t) })
        registerParser("RTE", { s -> RTEParser(s) }, { t -> RTEParser(t) })
        registerParser("RSA", { s -> RSAParser(s) }, { t -> RSAParser(t) })
        registerParser("RSD", { s -> RSDParser(s) }, { t -> RSDParser(t) })
        registerParser("TLB", { s -> TLBParser(s) }, { t -> TLBParser(t) })
        registerParser("TLL", { s -> TLLParser(s) }, { t -> TLLParser(t) })
        registerParser("TTM", { s -> TTMParser(s) }, { t -> TTMParser(t) })
        registerParser("TXT", { s -> TXTParser(s) }, { t -> TXTParser(t) })
        registerParser("UBX", { s -> UBXParser(s) }, { t -> UBXParser(t) })
        registerParser("VBW", { s -> VBWParser(s) }, { t -> VBWParser(t) })
        registerParser("VDM", { s -> VDMParser(s) }, { t -> VDMParser(t) })
        registerParser("VDO", { s -> VDOParser(s) }, { t -> VDOParser(t) })
        registerParser("VDR", { s -> VDRParser(s) }, { t -> VDRParser(t) })
        registerParser("VHW", { s -> VHWParser(s) }, { t -> VHWParser(t) })
        registerParser("VLW", { s -> VLWParser(s) }, { t -> VLWParser(t) })
        registerParser("VTG", { s -> VTGParser(s) }, { t -> VTGParser(t) })
        registerParser("VWR", { s -> VWRParser(s) }, { t -> VWRParser(t) })
        registerParser("VWT", { s -> VWTParser(s) }, { t -> VWTParser(t) })
        registerParser("WPL", { s -> WPLParser(s) }, { t -> WPLParser(t) })
        registerParser("XTE", { s -> XTEParser(s) }, { t -> XTEParser(t) })
        registerParser("XDR", { s -> XDRParser(s) }, { t -> XDRParser(t) })
        registerParser("ZDA", { s -> ZDAParser(s) }, { t -> ZDAParser(t) })
        registerParser("MDA", { s -> MDAParser(s) }, { t -> MDAParser(t) })
        registerParser("MWD", { s -> MWDParser(s) }, { t -> MWDParser(t) })
        registerParser("DTA", { s -> DTAParser(s) }, { t -> DTAParser(t) })
        registerParser("DTB", { s -> DTBParser(s) }, { t -> DTBParser(t) })
    }
